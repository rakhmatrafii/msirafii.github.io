...
<html lang="en">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Konten dari bot/bot.php disini -->
        </div>
    </div>
</div>
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> 0812345678</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> rakhmatrafi@gmail.com</a></li>
						...
						<li><?php
                            ...
                            if(isset($_SESSION["uid"])){
                               ...
                               <div class="dropdownn">
								...
								<!-- Inside header.php -->
								<li><a href="bot/bot.php"><i class="fa fa-headphones"></i> Customer Services</a></li>
